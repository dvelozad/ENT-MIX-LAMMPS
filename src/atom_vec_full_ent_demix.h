...
#ifdef ATOM_CLASS
// clang-format off
AtomStyle(full/entropy/demixing, AtomVecFullEntDemix)
// clang-format on
#else

#ifndef LMP_ATOM_VEC_FULL_ENT_DEMIX_H
#define LMP_ATOM_VEC_FULL_ENT_DEMIX_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecFullEntDemix : virtual public AtomVec {
 public:
  AtomVecFullEntDemix(class LAMMPS *);
  ~AtomVecFullEntDemix() override;
