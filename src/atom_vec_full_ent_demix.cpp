...
#include "atom_vec_full_ent_demix.h"
#include "atom.h"
...
AtomVecFullEntDemix::AtomVecFullEntDemix(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  // clang-format off
  fields_grow = {"q", "N",
    "molecule", "num_bond", "bond_type", "bond_atom", "num_angle", "angle_type",
  ...
  fields_copy = {"q","N", 
    ...
    "angle_atom1", "angle_atom2", "angle_atom3", "num_dihedral", "dihedral_type", "dihedral_atom1",
    "dihedral_atom2", "dihedral_atom3", "dihedral_atom4", "num_improper", "improper_type",
    "improper_atom1", "improper_atom2", "improper_atom3", "improper_atom4", "nspecial", "special", "lambdaH"};
  fields_border = {"q","N",
                     "molecule", "lambdaH"};
  fields_border_vel = {"q","N",
                       "molecule", "lambdaH"}; 
  fields_exchange = {"q","N", 
    ...
    "improper_atom2", "improper_atom3", "improper_atom4", "nspecial", "special", "lambdaH"};
 fields_restart = {"q", "N", 
  ...
  fields_create = {"q", "N", 
    "molecule", "num_bond", "num_angle",
    "num_dihedral", "num_improper", "nspecial"};
  fields_data_atom = {"id", "molecule", "type",  "q", "N", "x"};
...
AtomVecFullEntDemix::~AtomVecFullEntDemix()
{
...
void AtomVecFullEntDemix::grow_pointers()
{
...
void AtomVecFullEntDemix::pack_restart_pre(int ilocal)
{
...
void AtomVecFullEntDemix::pack_restart_post(int ilocal)
{
...
void AtomVecFullEntDemix::unpack_restart_init(int ilocal)
{
  nspecial[ilocal][0] = 0;
  nspecial[ilocal][1] = 0;
  nspecial[ilocal][2] = 0;
...
void AtomVecFullEntDemix::data_atom_post(int ilocal)
{
  num_bond[ilocal] = 0;
  num_angle[ilocal] = 0;
